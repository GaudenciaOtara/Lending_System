...
session_start();
 ...
 if (isset($_POST['submit'])){
	...
	if(empty($user_data)){
	  ...
	  echo("
		<script>
		  window.location.replace('./Customer_Dashboard/index.php');
		</script>
	  ");
	}
...
<body>
	...
	<form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="POST">
     ...
     <a href="#"> <h5 class="forgotpassword">Forgot password? <a href="customersignup.php" class="login">Signup</a></h5></a> 
    </form>
    </div>
</body>
</html>